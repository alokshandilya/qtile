...
def get_groupbox(visible_groups):
...
def init_widgets_list(visible_groups=None, is_primary=True):
    if not is_primary:
        # Minimal bar for the non-main screen: workspaces, layout, window
        # title and clock — no system stats.
        return [
            get_spacer(),
            get_groupbox(visible_groups),
            get_spacer(),
